...
public class GaeXmlService implements XmlService {
	...
	public String convertObjectToXml(ApplicationMessage messageObject) throws MessageException{
        ...
        // But let's write example bean as base element 'person'
			beanWriter.write("ApplicationMessage", messageObject);
	...
	@Override
	public ApplicationMessage convertXmlToObject(String applicationMessage,Class objectClass) throws MessageException{
        ...
        beanReader.registerBeanClass("ApplicationMessage", objectClass);
